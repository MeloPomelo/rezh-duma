...
export class AuthService {
  ...
  provider in Firestore database using AngularFirestore + AngularFirestoreDocument service */
    ...
    public updateUserData(newUserData: any): Promise<void> {
        const userRef: AngularFirestoreDocument<any> = this.afs.doc(
            `users/${newUserData.uid}`
        );

        // const userValidData: any = {
        //     uid: newUserData.uid,
        //     email: newUserData.email,
        //     displayName: newUserData.displayName,
        //     name: newUserData.name,
        //     lastName: newUserData.lastName,
        //     patronName: newUserData.patronName,
        ...
        //     numberHouse: newUserData.numberHouse,
        //     type: newUserData.type,
        // };

        return userRef.update(newUserData).then(() => {
